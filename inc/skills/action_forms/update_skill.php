...
if($_GET['skillsID']) {
    ...
    $sql = "SELECT * FROM skills WHERE  skillsID = {$skillsID}";
...
<div class="container">
    ...
    <form action="../actions/a_update_skill.php" method="post" class="my-2">
              ...
              <input type="hidden" name="skillsID" value="<?php echo $data['skillsID']?>">
