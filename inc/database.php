...
class Database{
    ...
    private $db_name = "alumni_project";  // Change as required
...
$object=new Database();
$object->connect();
$arr=array("skill"=>"text");
$object->insert("skills",$arr);
$where="skillsID=1";
$object->update("skills",$arr,$where);
if(isset($_POST["insert"])) {
    $object->uploadPhoto("images","image_url");
}
